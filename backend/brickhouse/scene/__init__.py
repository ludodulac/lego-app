...
__all__=[
    ...
    "FacadeEquipment","FacadeVisibility","GableRoofGeometry","GableRoofPlane","GradeProfile","MultiRunStairGeometryFacts","MultiRunStairGeometryReport","PhotoGeometryAnnotation","PhotoScaleCueBinding","Platform","PlatformEdge","PlatformEdges","PlatformStructureKind","PlatformStructureObservation","ProjectionIssue","ProjectionResult",
    ...
    "SupportPost","Terrain","VisibilitySpan","VisibilityState","VisualScaleCue","WallProfileObservation","analyze_multi_run_stair_geometry","analyze_scene_spatial_relations","analyze_stair_spatial","build_visual_scale_cues_from_photo_geometry","derive_roof_geometry","derive_scene_roof_geometry","estimate_architectural_scale","project_scene_to_building","scene_object_envelopes","validate_photo_geometry_annotations","validate_scene_against_survey",
]
