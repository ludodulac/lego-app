...
class EdgeAccessSpan(BaseModel):
    """Unprotected passage measured from the low-coordinate end of one platform edge."""
...
class PlatformEdges(BaseModel):
    """Each platform edge is independent. Offsets run x on y-edges and y on x-edges."""
...
class Platform(BaseModel):
    ...
    edge_treatment: EdgeTreatment | None = None  # legacy whole-perimeter hint
