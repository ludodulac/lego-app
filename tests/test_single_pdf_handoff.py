...
def test_single_pdf_exposes_current_handoff_version() -> None:
    source = ACTIVE_PACKAGE.read_text(encoding="utf-8")
    assert "PDF_HANDOFF_VERSION = 'pdf-handoff-0.10-hybrid-text'" in source
