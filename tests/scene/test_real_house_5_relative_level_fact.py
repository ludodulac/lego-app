...
def test_user_confirmed_timber_deck_lower_than_massive_landing_exposes_current_scene_defect() -> None:
    ...
    fact = HumanRelativeLevelFact.model_validate({
        "subject_observation_id": "platform-timber-1", "object_observation_id": "platform-massive-1", "relation": "lower_than",
        "certainty": "certain", "source": {"kind": "user_provided", "confidence": 1.0},
