...
def test_survey_v25_prompt_forbids_legacy_external_shapes() -> None:
    source = PROMPT.read_text(encoding="utf-8")
    assert "BRICKHOUSE — PROMPT DE RELEVÉ ARCHITECTURAL v2.5" in source
...
def test_survey_v25_prompt_requires_roof_and_exterior_multiview_audits() -> None:
    ...
    assert 'attribute_certainty.facade_is_gable:"plausible"' in source
