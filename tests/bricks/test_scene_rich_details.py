        ...
        "openings": [
            {
                ...
                "height": .75,
                "source": {"kind": "inferred", "confidence": .6},
                "evidence": [{"photo_index": 1, "observation": "ouverture basse en pavés de verre"}],
            },
            {
                "id": "left_glazed_door",
                "type": "door",
                ...
                "height": 2.25,
                "source": {"kind": "inferred", "confidence": .6},
                "evidence": [{"photo_index": 2, "observation": "porte-fenêtre vitrée au niveau terrasse"}],
            },
        ],
        "terrain": {
...
def test_grade_profile_survives_as_stepped_site_geometry() -> None:
