...
def test_bh233_frozen_reference_scene_reaches_first_real_brick_model():
    ...
    issues = [
        {"code": issue.code, "severity": issue.severity, "object_id": issue.object_id, "message": issue.message}
    ...
    summary = {
        ...
        "model_bounds": {"width_studs": bundle.brick_model.width_studs, "depth_studs": bundle.brick_model.depth_studs, "height_plates": bundle.brick_model.height_plates},
        "critical": critical,
