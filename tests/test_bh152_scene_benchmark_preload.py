...
EXPECTED_SHA = "82c14deb162ed9d89310dfaa051f38e22df66f2d"
...
def test_scene_page_wires_validated_candidate_preload_after_import_logic() -> None:
    ...
    preload_tag = "./scene-benchmark-candidate-preload.js?v=bh223-scene-candidate-preload-1"
    ...
    assert "BH-222" in html


def test_preload_is_scoped_to_real_house_scene_route_and_pinned_to_bh222_checkpoint() -> None:
    ...
    assert "dataset.preloadedCandidate = 'bh-222'" in source
...
def test_pinned_checkpoint_is_the_candidate_validated_by_bh222() -> None:
