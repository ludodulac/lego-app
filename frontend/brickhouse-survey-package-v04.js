...
if (status) {
  status.textContent = `Handoff ${PDF_HANDOFF_VERSION} prêt · ${PACKAGE_FILENAME} · sortie Survey uniquement · squelette JSON canonique inclus · contrôle anti-pages-noires actif`;
}
...
button?.addEventListener('click', async event => {
  ...
  try {
    ...
    const images = makeTextImages(commandText(records, topology, survey, outputContract));
