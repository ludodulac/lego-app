...
function compactObservation(item) {
  ...
  for (const key of ['physical_object_count', 'semantic_type', 'slope_direction', 'roof_type', 'facade_is_gable', 'facade_roof_relationship', 'roof_edge_type', 'stair_topology', 'subject_ownership']) {
